...
- Treat the documents under the [`docs/`](docs) folder as the primary source of truth for product requirements, technical specification, and architecture decisions.
- Review [`docs/specification.md`](docs/specification.md) and [`docs/design-architecture.md`](docs/design-architecture.md) before making implementation changes.
